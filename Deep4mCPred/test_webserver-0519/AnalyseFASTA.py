...
def get_sequence_odd(fasta_dict,positive_dict,idlist,nb_windows, empty_aa,focus):
    seq_list_2d = []
    id_list = []
    pos_list = []
    focus_list = []
...
def get_sequence_odd_fixed(fasta_dict,positive_dict,idlist):
    seq_list_2d = []
    id_list = []
    pos_list = []
    focus_list = []
    for id in idlist: #for sort
        ...
        final_seq_list = [0] + [ AA for AA in seq] 
...
def analyseFASTAPredict(fasta_file,windows=20,fill_letter="-",focus=("C")):

    fasta_dict,positive_dict,idlist = read_fasta(fasta_file) 
    
    sequence,ids,poses,focus = get_sequence_odd(fasta_dict,positive_dict,idlist, windows, fill_letter,focus)
    return sequence,ids,poses,focus

def analyseFixedPredict(fasta_file):

    fasta_dict,positive_dict,idlist = read_fasta(fasta_file) 
    
    sequence,ids,poses,focus = get_sequence_odd_fixed(fasta_dict,positive_dict,idlist)
