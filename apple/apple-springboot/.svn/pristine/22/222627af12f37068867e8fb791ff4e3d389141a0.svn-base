...
(function ($) {
    ...
    var isIE = function (ver) {
        ...
        tPreview = '<div class="file-preview {class}">\n' +
            ...
            '    </div>\n' +
            '</div>',
        tIcon = '<span class="fa fa-file-pictrue-o kv-caption-icon"></span>',
    ...
    FileInput.prototype = {
        ...
        previewDefault: function (file, previewId, isDisabled) {
            ...
            if (isDisabled === true) {
                ...
                footer += '<div class="file-other-error text-danger"><i class="fa fa-remove"></i></div>';
            }
    ...
    $.fn.fileinput.defaults = {
        ...
        msgValidationErrorIcon: '<i class="fa fa-remove-exclamation-sign"></i> ',
