...
public class EmailUtil {
    ...
    public static boolean sendEmail(List<User> userList){
        boolean result = false;
        if(userList==null || userList.isEmpty()){
            return result;
        }
        
        String to = userList.get(0).getEmail();// 收件人电子邮箱
        String subject = "西北农林科技大学创新创业服务平台 - 找回密码";
        String text = userList.toString();
        if(send(FORM,FORM_KEYWORD,to,subject,text)){
